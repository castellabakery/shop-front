...
const BuyerSignupPharmacy = function () {
    ...
    const onSubmit = useCallback((values) => {
        ...
        .then((res) => {
            if(res.data.data.seq){
                ...
                // })
                navigate("/login/signup/pharmacy/step4");
            } else{
                // 회원가입 롤백
            }
        }).catch((error) => {
    ...
    }, [checkData, setCheckData, initializeData, fileCheck, fileCheck2]);
                ...
                <Row className="buyer-signup-form">
                    ...
                    <div className='loginTextbox spacerTop'></div>
                        ...
                        >
                            ...
                            >
                                <Input className='input-middle' onChange={onChangeId}/>
                            </Form.Item>
                            ...
                            >
                                <Input.Password className='input-middle' onChange={onChangePassword}/>
                            </Form.Item>
                            ...
                            >
                                <Input.Password className='input-middle' ref={passwordChk} onChange={onChangePassword}/>
                            </Form.Item>
                            ...
                            >
                                <Input maxLength={100} className='input-middle'/>
                            </Form.Item>
                            ...
                            >
                                ...
                                <Input name='corpAddressEtc' maxLength={50} onBlur={onBlurAddress} className='input-large'/>
                            </Form.Item>
                            ...
                            >
                                <Upload
                                    ...
                                    onChange={(file) => uploadTest(file, "6")}
                                    maxCount={1}
                            ...
                            >
                                <Input defaultValue={sName} disabled={true} className="input-middle"/>
                            </Form.Item>
                            ...
                            >
                                <Input defaultValue={sMobileNo} disabled={true} className="input-middle"/>
                            ...
                            <div
                                className='align-center spacerTop'>
                                <Button href="/login/signup/pharmacy/step1" htmlType={"submit"} className={"login-form-button btn-color02-2 btn-huge btn-fix1"} style={{width : "200px"}}>취소</Button> <Button type={"primary"} htmlType={"submit"}  className={"login-form-button btn-color02 btn-huge btn-fix1"} style={{width : "200px"}}>회원가입</Button>
                            </div>
                        </Form>
                    </Col>
                </Row>
